# 4. Dataspace concepts

## 4.1 General

This does not define a dataspace...

## 4.2 Dataspace Protocol concepts
...
![Entities relevant for the dataspace protocol](figures/m.participant.entities.png)
