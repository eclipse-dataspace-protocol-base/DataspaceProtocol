...
| **Schema**          | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-request-message-schema.json) |
| **Example**         | [Message](../../artifacts/src/main/resources/transfer/example/transfer-request-message.json)    |
...
| **Response**        | [ACK](#ack-transfer-process) or [ERROR](#error-transfer-error)                                |
| **Schema**          | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-start-message-schema.json) |
| **Example**         | [Message](../../artifacts/src/main/resources/transfer/example/transfer-start-message.json)    |
...
| **Response**        | [ACK](#ack-transfer-process) or [ERROR](#error-transfer-error)                                     |
| **Schema**          | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-suspension-message-schema.json) |
| **Example**         | [Message](../../artifacts/src/main/resources/transfer/example/transfer-suspension-message.json)    |
...
| **Response**        | [ACK](#ack-transfer-process) or [ERROR](#error-transfer-error)                                     |
| **Schema**          | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-completion-message-schema.json) |
| **Example**         | [Message](../../artifacts/src/main/resources/transfer/example/transfer-completion-message.json)    |
...
| **Response**        | [ACK](#ack-transfer-process) or [ERROR](#error-transfer-error)                                      |
| **Schema**          | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-termination-message-schema.json) |
| **Example**         | [Message](../../artifacts/src/main/resources/transfer/example/transfer-termination-message.json)    |
...
|----------------|-----------------------------------------------------------------------------------------|
| **Sent by**    | [=Consumer=], [=Provider=]                                                              |
| **Schema**     | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-process-schema.json) |
| **Example**    | [Process](../../artifacts/src/main/resources/transfer/example/transfer-process.json)    |
...
|----------------|---------------------------------------------------------------------------------------|
| **Sent by**    | [=Consumer=], [=Provider=]                                                            |
| **Schema**     | [JSON Schema](../../artifacts/src/main/resources/transfer/transfer-error-schema.json) |
| **Example**    | [Process](../../artifacts/src/main/resources/transfer/example/transfer-error.json)    |
